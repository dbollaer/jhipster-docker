...
# install JHipster
RUN npm install -g generator-jhipster@2.12.0
...
RUN cd /home/jhipster && \
    wget https://github.com/jhipster/jhipster-sample-app/archive/v2.12.0.zip && \
    unzip v2.12.0.zip && \
    rm v2.12.0.zip
RUN cd /home/jhipster/jhipster-sample-app-2.12.0 && npm install
RUN cd /home && chown -R jhipster:jhipster /home/jhipster
RUN cd /home/jhipster/jhipster-sample-app-2.12.0 && sudo -u jhipster mvn dependency:go-offline
